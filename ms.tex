...
% mention that single-epoch fluxes grouped into one-day bins
% mention that single-epoch fluxes of each source were normalized
% to the average (median?) flux measured during the All-sky phase, and 
% that the AllWISE phase zero points were taken at face value, and
% that we used the single-exp ecl pole photometry to verify that the zero point 
% was stable at the $<=1 mmag$ level of the All-sky phase of the mission
