...
Instrument \citep[DESI,][]{desi}. Furthermore, folding in two additional scans
of WISE data at each sky location allows time-dependent artifacts to be nulled,
largely eliminating spatial nonuniformities in image quality and derivative 
catalogs.
...
\begin{figure*} [ht]
 \begin{center}
  ...
  \caption{\label{fig:w1_large} A subsection of the region displayed in Figure
           ...
           been completely eliminated in W1. The
...
Therefore, comparing the S/N of W1/W2 fluxes in DR2 versus DR1 can allow us to 
obtain estimates of the depth increases for regions of low ecliptic and high 
galactic latitude.
