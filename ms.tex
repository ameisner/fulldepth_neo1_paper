...
To make such a comparison, for each of W1 and W2, we select a sample of DECaLS 
DR2 sources with \verb|type|='PSF', \verb|wise_fracflux|$<$0.1, more than
one DECam observation, and WISE S/N within the range 10$\pm$1. We
